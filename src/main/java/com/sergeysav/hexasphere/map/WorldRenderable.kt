...
import com.sergeysav.hexasphere.gl.Vec2VertexAttribute
...
//                    println((0.5f + 0.5f * cos(i * 2f * PI / verts.size).toFloat() + u)/2 to (0.5f + 0.5f * sin(i * 2f * PI / verts.size).toFloat() + v)/2)
                }
                for (j in 2 until verts.size) {
